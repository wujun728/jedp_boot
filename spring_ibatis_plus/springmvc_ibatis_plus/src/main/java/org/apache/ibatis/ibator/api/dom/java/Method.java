...
public class Method extends JavaElement
{
    ...
    public void addJunitStart()
    {
        bodyLines.add("trans.execute(new TransactionCallback<Object>() {");
        bodyLines.add("public Object doInTransaction(TransactionStatus ts) {");
        bodyLines.add("boolean result = false;");
        bodyLines.add("int count;");
        bodyLines.add("List list;");
        bodyLines.add("try {");
    }
    
    public void addJunitEnd()
    {
        bodyLines.add("}");
        bodyLines.add("catch (Exception e) {");
        bodyLines.add("result = false;");
        bodyLines.add("logger.error(e);");
        bodyLines.add("}");
        bodyLines.add("finally {");
        bodyLines.add("ts.setRollbackOnly();");
        bodyLines.add("}");
        bodyLines.add("Assert.assertTrue(result);");

...
public interface DAOMethodNameCalculator
{
    ...
    /*****
     * getSelectAllWithoutBLOBsMethodName kalin
     * 
     * @param introspectedTable
     * @return
     * @see [类、类#方法、类#成员]
     */
    String getSelectAllWithoutBLOBsMethodName(IntrospectedTable introspectedTable);
    
    /*****
     * getSelectAllWithBLOBsMethodName kalin
     * 
     * @param introspectedTable
     * @return
     * @see [类、类#方法、类#成员]
     */
    String getSelectAllWithBLOBsMethodName(IntrospectedTable introspectedTable);
    ...
    /**
     * Calculates and returns a name for the select by example with BLOBs method. If the table contains BLOBs, then ibator will generate different select by example methods - one including BLOBs, one
     * not including BLOBs.
     * 
     * @param introspectedTable
     * @return the calculated name

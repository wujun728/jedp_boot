...
/**
 * This interface defines methods that will be called by ibator at different times during the code generation process. These methods can be used to extend or modify the code generated by ibator.
 * Clients may implement this interface in its entirety, or extend the IbatorPluginAdapter (highly recomended).
 * <p>
 ...
 * </ol>
 * 
 * Plugins are related to ibator contexts - so each context will have its own set of plugins. If the same plugin is specified in multple contexts, then each context will hold a unique instance of the
 * plugin.
 * <p>
 * Plugins are called, and initialized, in the same order they are specified in the configuration.
 * <p>
 * The daoXXX, modelXXX, and sqlMapXXX methods are called by the code generators supplied with ibator. If you replace ibator's default code generators with other implementations, these methods may not
 * be called.
 * 
 * @author Jeff Butler
...
public interface IbatorPlugin
{
    ...
    /**
     * This method is called just before the getGeneratedXXXFiles methods are called on the introspected table. Plugins can implement this method to override any of the default attributes, or change
     * the results of database introspection, before any code generation activities occur. Attributes are listed as static Strings with the prefix ATTR_ in IntrospectedTable.
     * <p>
     * A good example of overriding an attribute would be the case where a user wanted to change the name of one of the generated classes, change the target package, or change the name of the
     * generated SQL map file.
     * <p>
     * <b>Warning:</b> Anything that is listed as an attribute should not be changed by one of the other plugin methods. For example, if you want to change the name of a generated example class, you
     * should not simply change the Type in the <code>modelExampleClassGenerated()</code> method. If you do, the change will not be reflected in other generated artifacts.
     * 
    ...
    /**
     * This method is called after all the setXXX methods are called, but before any other method is called. This allows the plugin to determine whether it can run or not. For example, if the plugin
     * requires certain properties to be set, and the properties are not set, then the plugin is invalid and will not run.
     * 
     * @param warnings add strings to this list to specify warnings. For example, if the plugin is invalid, you should specify why. Warnings are reported to users after the completion of the ibator
     *            run.
     ...
     * 
     * @return a List of GeneratedJavaFiles - ibator will persist these files with the other files from this run of ibator.
     */
    List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles();
    
    /**
     * This method can be used to generate additional Java files needed by your implementation that might be related to a specific table. This method is called once for every table in the
     * configuration.
     * 
     * @param introspectedTable ibator's class containing information about the table as introspected from the database
     * @return a List of GeneratedJavaFiles - ibator will persist these files with the other files from this run of ibator.
     */
     ...
     * 
     * @return a List of GeneratedXmlFiles - ibator will persist these files with the other files from this run of ibator.
     */
    List<GeneratedXmlFile> contextGenerateAdditionalXmlFiles();
    
    /**
     * This method can be used to generate additional XML files needed by your implementation that might be related to a specific table. This method is called once for every table in the
     * configuration.
     * 
     * @param introspectedTable ibator's class containing information about the table as introspected from the database
     * @return a List of GeneratedXmlFiles - ibator will persist these files with the other files from this run of ibator.
     ...
     * @param introspectedTable ibator's class containing information about the table as introspected from the database
     * @return true if the interface should be generated, false if the generated interface should be ignored. In the case of multiple plugins, the first plugin returning false will disable the calling
     *         of further plugins.
     */
     ...
     * @param introspectedTable ibator's class containing information about the table as introspected from the database
     * @return true if the implementation class should be generated, false if the generated implementation class should be ignored. In the case of multiple plugins, the first plugin returning false
     ...
     * @param topLevelClass the partially implemented DAO implementation class. You can add additional imported classes to the implementation class if necessary.
     * @param introspectedTable ibator's class containing information about the table as introspected from the database
     * @return true if the method should be generated, false if the generated method should be ignored. In the case of multiple plugins, the first plugin returning false will disable the calling of
     *         further plugins.
     */
     ...
     * 
     * @param method the generated countByExample method
     * @param interfaze the partially implemented DAO interface class. You can add additional imported classes to the interface class if necessary.
     * @param introspectedTable ibator's class containing information about the table as introspected from the database
     * @return true if the method should be generated, false if the generated method should be ignored. In the case of multiple plugins, the first plugin returning false will disable the calling of
     *         further plugins.
     */
     ...
     * @param topLevelClass the partially implemented model class. You can add additional imported classes to the implementation class if necessary.
     * @param introspectedColumn ibator's class containing information about the column related to this field as introspected from the database
     * @param introspectedTable ibator's class containing information about the table as introspected from the database
     * @param modelClassType the type of class that the field is generated for
     * @return true if the field should be generated, false if the generated field should be ignored. In the case of multiple plugins, the first plugin returning false will disable the calling of
     *         further plugins.
     */
    ...
    /**
     * This method is called after the primary key class is generated by the ibator supplied JavaModelGenerator. This method will only be called if the table rules call for generation of a primary key
     * class.
     * <p/>
     ...
     * @param introspectedTable ibator's class containing information about the table as introspected from the database
     * @return true if the class should be generated, false if the generated class should be ignored. In the case of multiple plugins, the first plugin returning false will disable the calling of
     *         further plugins.
     */
    boolean modelPrimaryKeyClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable);
    
    /**
     * This method is called after the base record class is generated by the ibator supplied JavaModelGenerator. This method will only be called if the table rules call for generation of a base record
     * class.
     * <p/>
     * This method is only guaranteed to be called by the ibator supplied Java model generators. Other user supplied generators may, or may not, call this method.
     * 
    ...
    /**
     * This method is called after the record with BLOBs class is generated by the ibator supplied JavaModelGenerator. This method will only be called if the table rules call for generation of a
     ...
     * @param introspectedTable ibator's class containing information about the table as introspected from the database
     * @return true if the sqlMap should be generated, false if the generated sqlMap should be ignored. In the case of multiple plugins, the first plugin returning false will disable the calling of
     *         further plugins.
     */
     ...
     * 
     * @param document the generated document (note that this is ibator's internal Document class - not the w3c XML Document class)
     * @param introspectedTable ibator's class containing information about the table as introspected from the database
     * @return true if the document should be generated, false if the generated document should be ignored. In the case of multiple plugins, the first plugin returning false will disable the calling
     *         of further plugins. Also, if any plugin returns false, then the <tt>sqlMapGenerated</tt> method will not be called.
     */
     ...
     * @param introspectedTable ibator's class containing information about the table as introspected from the database
     * @return true if the element should be generated, false if the generated element should be ignored. In the case of multiple plugins, the first plugin returning false will disable the calling of
     *         further plugins.
     */

...
public class CountByExampleMethodGenerator extends AbstractDAOElementGenerator
{
    ...
    public void addImplementationElements(TopLevelClass topLevelClass)
    {
        ...
        sb.append(daoTemplate.getQueryForObjectMethod(table.getSqlMapNamespace(), XmlConstants.COUNT_BY_EXAMPLE_STATEMENT_ID, "example")); //$NON-NLS-1$
    ...
    public void addJunitElements(JunitTestClass junitClass)
    {
        ...
        method.addBodyLine(sb.toString());
        sb.setLength(0);
        sb.append("list = ").append(beanId).append(".selectByExample(example);");
        method.addBodyLine(sb.toString());
        sb.setLength(0);
        sb.append("count = ").append(beanId).append(".countByExample(example);");
        method.addBodyLine(sb.toString());
        method.addBodyLine("Assert.assertEquals(list.size(), count);");

...
/**
 * This class includes no-operation methods for almost every method in the IbatorPlugin interface. Clients may extend
 * this class to implement some or all of the methods in a plugin.
 * <p>

 ...
 * 
 */
public class QueryPagingEntitiesWithBLOBsMethodGenerator extends AbstractDAOElementGenerator
{
    private boolean generateForJava5;
    
    public QueryPagingEntitiesWithBLOBsMethodGenerator(boolean generateForJava5)
    {
        super();
    ...
    public void addImplementationElements(TopLevelClass topLevelClass)
    {
        ...
        method.addBodyLine(String.format("String statementName =\"%s.%s\";", table.getSqlMapNamespace(), XmlConstants.SELECT_BY_EXAMPLE_WITH_BLOBS_STATEMENT_ID));
        if (generateForJava5)
        {

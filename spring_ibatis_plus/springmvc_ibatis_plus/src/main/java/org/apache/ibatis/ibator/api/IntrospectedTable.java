...
/**
 * Base class for all code generator implementations. This class provides many of the Ibator housekeeping methods needed to implement a code generator, with only the actual code generation methods
 * left unimplemented.
 * 
 * @author Jeff Butler
 * 
...
public abstract class IntrospectedTable
{
    ...
    /**
     * Returns the columns in the primary key. If the generatePrimaryKeyClass() method returns false, then these columns will be iterated as the parameters of the selectByPrimaryKay and
    ...
    /**
     * 
     * @return the type for the record (the class that holds non-primary key and non-BLOB fields). Note that the value will be calculated regardless of whether the table has these columns or not.
     */

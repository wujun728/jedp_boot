...
<div class="layui-container fly-marginTop  fly-user-main">
    <ul class="layui-nav layui-nav-tree layui-inline" lay-filter="user">
        ...
        <li class="layui-nav-item layui-this">
            <a href="/user/Set" onclick="">
                <i class="layui-icon">&#xe620;</i>
                基本设置
            </a>
        </li>
        <li class="layui-nav-item">
            <a href="/user/message" onclick="">
                <i class="layui-icon">&#xe611;</i>
                我的消息
            </a>
        </li>
    ...
    <div class="fly-panel fly-panel-user " pad20="">
        <div class="layui-tab layui-tab-brief" lay-filter="user">
            ...
            <div class="layui-tab-content" style="padding: 20px 0;">
                ...
                <div class="layui-form layui-form-pane layui-tab-item">
                    <div class="layui-form-item">
                        <div class="avatar-add">
                            ...
                            <%--<img id="userImg" src="https://tva1.sinaimg.cn/crop.0.0.118.118.180/5db11ff4gw1e77d3nqrv8j203b03cweg.jpg">--%>
                ...
                <div class="layui-form layui-form-pane layui-tab-item">
                    <form action="/user/rePass" method="post" id="rePass">
                        <div class="layui-form-item">
                            <label for="L_nowpass" class="layui-form-label">当前密码</label>
                            <div class="layui-input-inline">
                                <input type="text" name="userid" hidden="hidden" value="${sessionScope.session_User.id}">
                        ...
                        <div class="layui-form-item">
                            <button class="layui-btn"  lay-filter="*"onclick="rePass()">确认修改</button>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    ...
    function rePass() {
         $.ajax({
             ...
             type: "post",
             DataType: "json",
             Data:$("#rePass").serialize(),//将表单数据序列化作为参数提交
             success: function () {
                    layui.use('layer',function () {
                        var layer = layui.layer;
                        layer.msg("修改成功！");
...
<script src="${pageContext.request.contextPath}/resource/bbs_resourse/js/user.js" charset="utf-8"></script>
</html>

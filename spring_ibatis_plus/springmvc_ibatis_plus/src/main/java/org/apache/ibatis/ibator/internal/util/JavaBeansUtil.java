...
public class JavaBeansUtil
{
     ...
     * JavaBeans rules:
     * 
     * eMail > geteMail() firstName > getFirstName() URL > getURL() XAxis > getXAxis() a > getA() B > invalid - this method assumes that this is not the case. Call getValidPropertyName first. Yaxis >
     * invalid - this method assumes that this is not the case. Call getValidPropertyName first.
     * 
     * @param property
     ...
     * JavaBeans rules:
     * 
     * eMail > seteMail() firstName > setFirstName() URL > setURL() XAxis > setXAxis() a > setA() B > invalid - this method assumes that this is not the case. Call getValidPropertyName first. Yaxis >
     * invalid - this method assumes that this is not the case. Call getValidPropertyName first.
     * 
     * @param property
     ...
     * 
     * 1. If the first character is lower case, then OK 2. If the first two characters are upper case, then OK 3. If the first character is upper case, and the second character is lower case, then the

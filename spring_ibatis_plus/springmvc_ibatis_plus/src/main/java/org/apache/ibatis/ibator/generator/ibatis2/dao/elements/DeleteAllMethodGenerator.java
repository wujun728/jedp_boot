 ...
 * 
 */
public class DeleteAllMethodGenerator extends AbstractDAOElementGenerator
{
    public DeleteAllMethodGenerator()
    {
        super();
    }
    ...
    public void addImplementationElements(TopLevelClass topLevelClass)
    {
        ...
        sb.append(daoTemplate.getDeleteMethod(table.getSqlMapNamespace(), XmlConstants.DELETE_BY_EXAMPLE_STATEMENT_ID, String.format("new %s()", type.getShortName()))); //$NON-NLS-1$
    ...
    public void addJunitElements(JunitTestClass junitClass)
    {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(type.getShortName()).append(" example = new ").append(type.getShortName()).append("();");
        method.addBodyLine(sb.toString());
        sb.setLength(0);
        sb.append("count = ").append(beanId).append(".countByExample(example);");
        method.addBodyLine(sb.toString());
        sb.setLength(0);
        sb.append("Assert.assertEquals(count, ").append(beanId).append(".deleteAll());");
        method.addBodyLine(sb.toString());

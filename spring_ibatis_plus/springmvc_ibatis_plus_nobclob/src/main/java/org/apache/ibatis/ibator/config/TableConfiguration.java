...
public class TableConfiguration extends PropertyHolder
{
    ...
    {
        return selectByExampleStatementEnabled || selectByPrimaryKeyStatementEnabled || insertStatementEnabled || updateByPrimaryKeyStatementEnabled || deleteByExampleStatementEnabled
            || deleteByPrimaryKeyStatementEnabled || countByExampleStatementEnabled || updateByExampleStatementEnabled;
    }
    ...
    /**
     * This method returns an iterator of Strings. The values are the columns that were specified to be ignored in the

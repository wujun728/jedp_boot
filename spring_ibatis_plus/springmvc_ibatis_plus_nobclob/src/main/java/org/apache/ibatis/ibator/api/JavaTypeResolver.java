...
public interface JavaTypeResolver
{
    ...
    /**
     * ibator will supply a list to this method. The implementation class may add strings to the list that will be
     * treated as warning messages and displayed to the user. The concept of a warning is that code generation can
     ...
     * @return true the calculated type, or null if an unsupported data type. If null is returned, ibator will set the
     *         type to Object and issue a warning unless the column is ignored or otherwise overridden
     */

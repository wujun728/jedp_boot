    ...
    this.render = function (a, j) {
        ...
        function s(a, e, g) {
            ...
            if (g instanceof THREE.ParticleBasicMaterial) {
                if (g.map) m = g.map.image, q = m.width >> 1, n = m.height >> 1, g = e.scale.x * o, i = e.scale.y * p, h = g * q,
                    j = i * n, X.set(a.x - h, a.y - j, a.x + h, a.y + j),
...
//         var material = new THREE.({map: new THREE.Texture(particleImage)});

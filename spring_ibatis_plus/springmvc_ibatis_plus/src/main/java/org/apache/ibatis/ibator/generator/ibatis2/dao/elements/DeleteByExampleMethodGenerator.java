...
public class DeleteByExampleMethodGenerator extends AbstractDAOElementGenerator
{
    ...
    public void addImplementationElements(TopLevelClass topLevelClass)
    {
        ...
        sb.append(daoTemplate.getDeleteMethod(table.getSqlMapNamespace(), XmlConstants.DELETE_BY_EXAMPLE_STATEMENT_ID, "example")); //$NON-NLS-1$
    ...
    public void addJunitElements(JunitTestClass junitClass)
    {
        ...
        method.addBodyLine(sb.toString());
        sb.setLength(0);
        sb.append("Assert.assertEquals(count, ").append(beanId).append(".deleteByExample(example));");
        method.addBodyLine(sb.toString());

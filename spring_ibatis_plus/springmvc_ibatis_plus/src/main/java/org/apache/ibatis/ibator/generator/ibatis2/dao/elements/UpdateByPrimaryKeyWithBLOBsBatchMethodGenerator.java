 ...
 * 
 */
public class UpdateByPrimaryKeyWithBLOBsBatchMethodGenerator extends AbstractDAOElementGenerator
{
    private boolean generateForJava5;
    
    public UpdateByPrimaryKeyWithBLOBsBatchMethodGenerator(boolean generateForJava5)
    {
        super();
    ...
    public void addImplementationElements(TopLevelClass topLevelClass)
    {
        ...
        {
            keyType = introspectedTable.getRecordWithBLOBsType();
        }
        else
        {
        ...
        sb.append(String.format("             executor.update(\"%s.%s\",it);", table.getSqlMapNamespace(), XmlConstants.UPDATE_BY_PRIMARY_KEY_WITH_BLOBS_STATEMENT_ID)).append(lineSeparator);
    ...
    public void addJunitElements(JunitTestClass junitClass)
    {
        ...
        method.setName(getDAOMethodNameCalculator().getUpdateByPrimaryKeyWithBLOBsMethodName(introspectedTable) + "List");
        StringBuilder sb = new StringBuilder();
    ...
    private Method getMethodShell(Set<FullyQualifiedJavaType> importedTypes)
    {
        ...
        if (generateForJava5)
        {
            ...
            if (introspectedTable.getRules().generateRecordWithBLOBsClass())
            {
                type = introspectedTable.getRecordWithBLOBsType();
            }
            else
            {

...
/**
 * This plugin generates an SqlMapConfig file containing sqlMap entries for SQL maps generated by ibator. This demonstrates hooking into the ibator code generation lifecycle and generating additional
 * XML files.
 * <p>
 * This plugin accepts three properties:
 * <ul>
 * <li><tt>fileName</tt> (optional) the name of the generated file. this defaults to "SqlMapConfig.xml" if not specified.</li>
 * <li><tt>targetPackage</tt> (required) the name of the package where the file should be placed. Specified like "com.mycompany.sql".</li>
 * <li><tt>targetProject</tt> (required) the name of the project where the file should be placed.</li>
 * </ul>
 * 
...
public class SqlMapConfigPlugin extends IbatorPluginAdapter
{
    ...
    {
        Document document = new Document(XmlConstants.SQL_MAP_CONFIG_PUBLIC_ID, XmlConstants.SQL_MAP_CONFIG_SYSTEM_ID);
        XmlElement root = new XmlElement("sqlMapConfig"); //$NON-NLS-1$
        document.setRootElement(root);
        root.addElement(new TextElement("<!--")); //$NON-NLS-1$
        root.addElement(new TextElement("  This file is generated by Apache iBATIS ibator.")); //$NON-NLS-1$
        root.addElement(new TextElement("  This file is the shell of an SqlMapConfig file - in many cases you will need to add")); //$NON-NLS-1$
    ...
    /*
     * This method collects the name of every SqlMap file generated by ibator in this context.
     */
    @Override

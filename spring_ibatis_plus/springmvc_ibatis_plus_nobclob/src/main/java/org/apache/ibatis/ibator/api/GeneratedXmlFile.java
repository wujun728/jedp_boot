...
public class GeneratedXmlFile extends GeneratedFile
{
     ...
     * @param targetPackage
     * @param targetProject
     * @param isMergeable true if the file can be merged by the built in XML file merger. Files are mergeable if all
     *            mergeable elements contain id's with the "ibatorgenerated_" prefix.
     */

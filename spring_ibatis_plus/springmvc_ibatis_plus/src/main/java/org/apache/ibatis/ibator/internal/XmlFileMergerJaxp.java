...
public class XmlFileMergerJaxp
{
    ...
    {
        /**
         * returns an empty reader. This is done so that the parser doesn't attempt to read a DTD. We don't need that support for the merge and it can cause problems on systems that aren't Internet
         * connected.
         */
        @Override

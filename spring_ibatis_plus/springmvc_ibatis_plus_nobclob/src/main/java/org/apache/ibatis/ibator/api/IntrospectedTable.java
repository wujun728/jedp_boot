...
/**
 * Base class for all code generator implementations. This class provides many of the Ibator housekeeping methods needed
 * to implement a code generator, with only the actual code generation methods left unimplemented.
 * 
 * @author Jeff Butler
 * 
 */
public abstract class IntrospectedTable
{
    ...
    /**
     * Attributes may be used by plugins to capture table related state between the different plugin calls. Attributes
     * also are used to store commonly accessed items by all code generators
     */

...
public class TextElement extends Element
{
    ...
    /**
     * Utility method. Takes a long string and breaks it into multiple lines of whose width is no longer that the
     ...
     */
    private static String formatLongString(String s, int maxLineLength, int indentLevel)
    {

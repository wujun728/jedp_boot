 ...
 * 2018-03-29T17:51:25.561+08:00
 * Generated source version: 3.2.2
 *
 */
@WebServiceClient(name = "WeatherWebService",
                  wsdlLocation = "file:WeatherWebService.xml",
...
public class WeatherWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:WeatherWebService.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherWebService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:WeatherWebService.xml");
        }
        WSDL_LOCATION = url;
    }

 ...
 * <p>
 * The <tt>equals</tt> method generated by this class is correct in most cases, but will probably NOT be correct if you have specified a rootClass - because our equals method only checks the fields it
 * knows about.
 * <p>
 * The <tt>hashCode</tt> method generated by this class is a very simplistic implementation. A better implementation would rely on the HashCodeUtil from www.javapractices.com - but we do not want to
 * introduce another dependency in this simple plugin.
 * 
 * @author Jeff Butler
 * 
 */
public class EqualsHashCodePlugin extends IbatorPluginAdapter
{
    ...
    /**
     * Generates a <tt>hashCode</tt> method that multiplies the hashCodes of all fields.
     * <p>

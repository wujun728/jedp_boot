 ...
 * 
 * During the execution of code generation, there are three main operations: database introspection, code generation based on the results of introspection, and then merging/saving generated files.
 ...
 * </ol>
 * <p>
 * Periodically, ibator will call <code>checkCancel()</code> to see if the method should be canceled.
 * <p>
...
public interface ProgressCallback
{
     ...
     * 
     * @param totalTasks the maximum number of times startTask will be called for the introspection phase.
     */
     ...
     * 
     * @param totalTasks the maximum number of times startTask will be called for the file saving phase.
     */
    ...
    /**
     * ibator will call this method periodically during a long running method. If the the implementation throws <code>InterruptedException</code> then the method will be canceled. Any files that have
     * already been saved will remain on the file system.
     * 

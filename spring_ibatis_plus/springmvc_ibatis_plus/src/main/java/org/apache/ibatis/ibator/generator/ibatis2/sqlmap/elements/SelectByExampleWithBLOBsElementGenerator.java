...
public class SelectByExampleWithBLOBsElementGenerator extends AbstractXmlElementGenerator
{
    ...
    public void addElements(XmlElement parentElement)
    {
        ...
        answer.addAttribute(new Attribute("id", XmlConstants.SELECT_BY_EXAMPLE_WITH_BLOBS_STATEMENT_ID)); //$NON-NLS-1$
        answer.addAttribute(new Attribute("resultMap", XmlConstants.RESULT_MAP_WITH_BLOBS_ID)); //$NON-NLS-1$

 ...
 * 
 */
public class InsertSelectiveBatchMethodGenerator extends AbstractDAOElementGenerator
{
    private boolean generateForJava5;
    
    public InsertSelectiveBatchMethodGenerator(boolean generateForJava5)
    {
        super();
    ...
    public void addImplementationElements(TopLevelClass topLevelClass)
    {
        ...
        sb.append(String.format("             executor.insert(\"%s.%s\",it);", table.getSqlMapNamespace(), XmlConstants.INSERT_SELECTIVE_STATEMENT_ID)).append(lineSeparator);

...
/**
 * This class is used to specify a renaming fule for columns in a table. This renaming rule will be run against all column names before calculating the corresponding property name. The most common use
 * case is when columns in a table are all prefixed by a certain value.
 * 
 ...
 * </ul>
 * 
 * Note that internally, ibator uses the <code>java.util.regex.Matcher.replaceAll</code> method for this function. See the documentation of that method for example of the regular expression language
 * used in Java.
 * 
 * @author Jeff Butler
 * 

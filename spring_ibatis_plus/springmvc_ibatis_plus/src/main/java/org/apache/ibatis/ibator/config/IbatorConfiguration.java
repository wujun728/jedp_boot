...
public class IbatorConfiguration
{
    ...
    /**
     * This method does a simple validate, it makes sure that all required fields have been filled in and that all implementation classes exist and are of the proper type. It does not do any more
     * complex operations such as: validating that database tables exist or validating that named columns exist
     */

 ...
 * 
 */
public class SelectAllWithBLOBsMethodGenerator extends AbstractDAOElementGenerator
{
    private boolean generateForJava5;
    
    public SelectAllWithBLOBsMethodGenerator(boolean generateForJava5)
    {
        super();
    ...
    public void addImplementationElements(TopLevelClass topLevelClass)
    {
        ...
        sb.append(daoTemplate.getQueryForListMethod(table.getSqlMapNamespace(), XmlConstants.SELECT_BY_EXAMPLE_WITH_BLOBS_STATEMENT_ID, "null")); //$NON-NLS-1$
    ...
    public void addJunitElements(JunitTestClass junitClass)
    {
        ...
        method.setName(getDAOMethodNameCalculator().getSelectAllWithBLOBsMethodName(introspectedTable));
        StringBuilder sb = new StringBuilder();

...
public class SelectByPrimaryKeyElementGenerator extends AbstractXmlElementGenerator
{
    ...
    public void addElements(XmlElement parentElement)
    {
        ...
        answer.addAttribute(new Attribute("id", XmlConstants.SELECT_BY_PRIMARY_KEY_STATEMENT_ID)); //$NON-NLS-1$
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable.getPrimaryKeyColumns())
        {
            ...
            sb.append(" = "); //$NON-NLS-1$
            sb.append(introspectedColumn.getIbatisFormattedParameterClause().replaceAll(":\\w*", ""));
            answer.addElement(new TextElement(sb.toString()));
        }

...
public interface CommentGenerator
{
     ...
     * <p>
     * 
     * <b>Important:</b> This method should add a the nonstandard JavaDoc tag "@ibatorgenerated" to the comment. Without this tag, the Eclipse based Java merge feature will fail.
     * 
     * @param field
     * @param table
     * @param columnName
    ...
    /**
     * This method is called to add a file level comment to a generated java file. This method could be used to add a general file comment (such as a copyright notice). However, note that the Java
     * file merge function in Eclipse does not deal with this comment. If you run ibator repeatedly, you will only retain the comment from the initial run.
     * <p>
     * 
    ...
    /**
     * This method is called to add a comment as the first child of the root element. This method could be used to add a general file comment (such as a copyright notice). However, note that the XML
     * file merge function does not deal with this comment. If you run ibator repeatedly, you will only retain the comment from the initial run.
     * <p>
     * 
     * The default implementation does nothing.
     * 

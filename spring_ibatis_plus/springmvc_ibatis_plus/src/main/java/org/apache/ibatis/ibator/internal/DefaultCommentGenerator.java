...
public class DefaultCommentGenerator implements CommentGenerator
{
    ...
    /**
     * This method adds the custom javadoc tag for ibator. You may do nothing if you do not wish to include the Javadoc tag - however, if you do not include the Javadoc tag then the Java merge

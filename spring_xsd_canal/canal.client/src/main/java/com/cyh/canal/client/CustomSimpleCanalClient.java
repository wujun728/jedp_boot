...
import com.cyh.canal.config.CanalConfig;
import com.cyh.canal.config.SingleCanalConfig;
import com.cyh.canal.config.SocketsClusterCanalConfig;
import com.cyh.canal.config.ZkClusterCanalConfig;
import com.cyh.canal.invoke.ICanalInvoke;
import com.cyh.canal.spring.SpringContextHolder;
...
public class CustomSimpleCanalClient implements ApplicationContextAware{
    ...
    public void initInvoke(){
        ...
        invokeMap = new HashMap<String, List<ICanalInvoke>>();
    ...
    public void setInvokeMapIOC(Map<String, List<String>> invokeMapIOC) {
        ...
        this.invokeMapIOC = new HashMap<String, List<String>>();

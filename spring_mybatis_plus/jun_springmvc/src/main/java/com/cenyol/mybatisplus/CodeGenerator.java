...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 数据源配置
        mpg.setDataSource(loadDataSourceConfig());
        ...
        // 公共父类
        strategy.setSuperControllerClass( BASE_PACKAGE + ".common.controller.CurdController");
    ...
    private static DataSourceConfig loadDataSourceConfig() {

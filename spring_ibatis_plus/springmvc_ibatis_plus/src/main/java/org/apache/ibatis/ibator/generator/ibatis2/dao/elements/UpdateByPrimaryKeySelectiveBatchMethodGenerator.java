 ...
 * 
 */
public class UpdateByPrimaryKeySelectiveBatchMethodGenerator extends AbstractDAOElementGenerator
{
    private boolean generateForJava5;
    
    public UpdateByPrimaryKeySelectiveBatchMethodGenerator(boolean generateForJava5)
    {
        super();
    ...
    public void addImplementationElements(TopLevelClass topLevelClass)
    {
        ...
        sb.append(String.format("             executor.update(\"%s.%s\",it);", table.getSqlMapNamespace(), XmlConstants.UPDATE_BY_PRIMARY_KEY_SELECTIVE_STATEMENT_ID)).append(lineSeparator);
    ...
    public void addJunitElements(JunitTestClass junitClass)
    {
        ...
        method.setName("updateByPrimaryKeySelectiveList");
        StringBuilder sb = new StringBuilder();

...
public class IbatorContext extends PropertyHolder
{
    ...
    /**
     * This method does a simple validate, it makes sure that all required fields have been filled in. It does not do any more complex operations such as validating that database tables exist or
    ...
    /**
     * Builds an XmlElement representation of this context. Note that the XML may not necessarily validate if the context is invalid. Call the <code>validate</code> method to check validity of this
     * context.
     * 
        ...
        throws SQLException, InterruptedException
    {
        ...
        JavaTypeResolver javaTypeResolver = IbatorObjectFactory.createJavaTypeResolver(IbatorContext.this, warnings);
        Connection connection = null;
        try
        {
            callback.startTask(Messages.getString("Progress.0")); //$NON-NLS-1$
            connection = getConnection();
            DatabaseIntrospector databaseIntrospector = new DatabaseIntrospector(IbatorContext.this, connection.getMetaData(), javaTypeResolver, warnings);
        ...
        throws InterruptedException
    {
        ...
        for (IbatorPluginConfiguration ibatorPluginConfiguration : pluginConfigurations)
        {
            IbatorPlugin plugin = IbatorObjectFactory.createIbatorPlugin(IbatorContext.this, ibatorPluginConfiguration);

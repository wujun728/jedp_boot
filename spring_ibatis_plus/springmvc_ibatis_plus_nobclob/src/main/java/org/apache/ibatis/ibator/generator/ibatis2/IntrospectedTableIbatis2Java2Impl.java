...
public class IntrospectedTableIbatis2Java2Impl extends IntrospectedTable
{
    ...
    public List<GeneratedXmlFile> getGeneratedXmlFiles()
    {
        ...
        GeneratedXmlFile gxf = new GeneratedXmlFile(document, getSqlMapFileName(), getSqlMapPackage(), ibatorContext.getSqlMapGeneratorConfiguration().getTargetProject(), true);
    ...
    {
        return javaModelGenerators.size() + daoGenerators.size() + 1; // 1 for the sqlMapGenerator
    }
}

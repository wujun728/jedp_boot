 ...
 * 	return;
 * }
 * System.out.println(ii.getFormatName() + ", " + ii.getMimeType() + ", " + ii.getWidth() + " x " + ii.getHeight() + " pixels, " + ii.getBitsPerPixel() + " bits per pixel, "
 * 		+ ii.getNumberOfImages() + " image(s), " + ii.getNumberOfComments() + " comment(s).");
 ...
 * <a href="http://schmidt.devlib.org/image-info/">http://schmidt.devlib.org/
 * image-info/</a>.
 * <p>
 * Written by Marco Schmidt.
 * <p>
 ...
 * cut(1) and other Unix tools). Added some points to the
 * <a href="http://schmidt.devlib.org/image-info/index.html#knownissues">'Known
 ...
 * and sending in code. Released as 1.8.</li></li>
...
public class ImageInfo {
	 ...
	 */
	private static final String[] MIME_TYPE_STRINGS = { "image/jpeg", "image/gif", "image/png", "image/bmp", "image/pcx", "image/iff", "image/ras", "image/x-portable-bitmap",
	...
	private static void printCompact(String sourceName, ImageInfo imageInfo) {
		final String SEP = "\t";
		System.out.println(sourceName + SEP + imageInfo.getFormatName() + SEP + imageInfo.getMimeType() + SEP + imageInfo.getWidth() + SEP + imageInfo.getHeight() + SEP
				+ imageInfo.getBitsPerPixel() + SEP + imageInfo.getNumberOfImages() + SEP + imageInfo.getPhysicalWidthDpi() + SEP + imageInfo.getPhysicalHeightDpi() + SEP
				+ imageInfo.getPhysicalWidthInch() + SEP + imageInfo.getPhysicalHeightInch() + SEP + imageInfo.isProgressive());
	}
